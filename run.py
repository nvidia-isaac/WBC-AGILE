...
class RunConfig:
    ...
    omni_server_url: str
    osmo_output_url_prefix: str | None
    ...
    def load_from_path(cls, path: pathlib.Path) -> "RunConfig":
        ...
        flattened = {
            ...
            "osmo_output_url_prefix": data["storage"].get("osmo_output_url_prefix"),
...
def handle_train_single(
    ...
    submit_osmo_workflow(
        ...
        + ([f"storage_url_prefix={run_config.osmo_output_url_prefix}"] if run_config.osmo_output_url_prefix else [])
        + set_args,

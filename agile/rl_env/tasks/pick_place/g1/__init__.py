...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_pick_place_tracking_env_cfg:G1PickPlaceTrackingEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_pick_place_tracking_env_cfg:G1PickPlaceTrackingEnvCfgDebug",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1PickPlacePPORunnerCfg",
    },
)

...
class RslRlRndCfg:
    ...
    class LinearWeightScheduleCfg(WeightScheduleCfg):
        ...
        For steps before this step, the weight is the initial value specified in
        :attr:`RslRlRndCfg.weight`.
        """

        final_step: int = MISSING
        """The final step of the weight schedule.

        For steps after this step, the weight is the final value specified in
        :attr:`final_value`.
        """
    ...
    class StepWeightScheduleCfg(WeightScheduleCfg):
        ...
        This schedule sets the weight to the value specified in :attr:`final_value` at step
        :attr:`final_step`.
        """
    ...
    """The weight schedule for the RND reward. Default is None, which means the weight
    is constant."""

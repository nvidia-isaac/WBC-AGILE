...
- **velocity_height_g1/** - Teacher and recurrent student policies
...
| `velocity_height_g1/unitree_g1_velocity_height_teacher.pt` | `Velocity-Height-G1-v0` | Checkpoint | G1 teacher with height map |
